  ...
  const TRANSLATIONS = {
    en: {
      ...
      accountGate: {
        ...
        passwordHint: 'Minimum 8 characters, with at least one letter, one number, and one special character (! @ # $ % & *).',
    ...
    fr: {
      ...
      accountGate: {
        ...
        passwordHint: 'Minimum 8 caractères, avec au moins une lettre, un chiffre et un caractère spécial (! @ # $ % & *).',
