  ...
  const TRANSLATIONS = {
    en: {
      ...
      checkout: {
        ...
        confirmationText: 'Your payment was processed and your order has been recorded. A confirmation email will be sent to you shortly.',
        ...
        confirmationEmailSentTo: 'Confirmation sent to {email}',
        confirmationReference: 'Order reference: {reference}',
      ...
      accountGate: {
        ...
        passwordHint: 'Minimum 8 characters, with at least one letter, one number, and one special character (e.g. ! @ # $ % -).',
        passwordReqLength: '8+ characters',
        passwordReqLetter: 'One letter',
        ...
        errorPasswordWeak: 'Password must be at least 8 characters and include a letter, a number, and a special character (! @ # $ % & *).',
        errorSamePassword: 'Your new password must be different from your current one.',
      ...
      account: {
        ...
        orderShipped: 'Shipped on {date}',
        orderDelivered: 'Delivered on {date}',
        guestOrderHistoryNote: 'Create an account to view your order history & more.',
        guestCreateAccountBtn: 'Create an Account',
        guestExistingAccountNote: 'An account already exists for this email. Enter your password to access it.',
        guestLoginBtn: 'Enter Password',
    ...
    fr: {
      ...
      checkout: {
        ...
        confirmationText: "Votre paiement a été traité et votre commande a été enregistrée. Un e-mail de confirmation vous sera envoyé sous peu.",
        ...
        confirmationEmailSentTo: 'Confirmation envoyée à {email}',
        confirmationReference: 'Référence de commande : {reference}',
      ...
      accountGate: {
        ...
        passwordHint: 'Minimum 8 caractères, avec au moins une lettre, un chiffre et un caractère spécial (ex. ! @ # $ % -).',
        passwordReqLength: '8 caractères ou plus',
        passwordReqLetter: 'Une lettre',
        passwordReqNumber: 'Un chiffre',
        passwordReqSpecial: 'Un caractère spécial (ex. ! @ # $ % -)',
        ...
        errorPasswordWeak: 'Le mot de passe doit contenir au moins 8 caractères, dont une lettre, un chiffre et un caractère spécial (! @ # $ % & *).',
      ...
      account: {
        ...
        orderQty: 'Qté {qty}',
        orderTotalLine: 'Total : {total}',
        orderShipped: 'Expédiée le {date}',
        orderDelivered: 'Livrée le {date}',
        ...
        guestExistingAccountNote: 'Un compte existe déjà pour cet e-mail. Entrez votre mot de passe pour y accéder.',
        guestLoginBtn: 'Entrer le Mot de Passe',
