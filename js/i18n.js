  ...
  const TRANSLATIONS = {
    en: {
      ...
      checkout: {
        ...
        whatsappHref: 'https://api.whatsapp.com/send?phone=33605893897&text=Hello%2C%20I%20have%20a%20question%20about%20my%20order.',
      ...
      privacyPolicy: {
        ...
        transfersItem1: "Netlify, Inc., our hosting provider, based in the United States (San Francisco), which serves the site's files and processes visitor connection data (IP addresses, request logs) as part of hosting;",
    ...
    fr: {
      ...
      checkout: {
        ...
        whatsappHref: "https://api.whatsapp.com/send?phone=33605893897&text=Bonjour%2C%20j%27ai%20une%20question%20%C3%A0%20propos%20de%20ma%20commande.",
      ...
      privacyPolicy: {
        ...
        transfersItem1: "Netlify, Inc., notre hébergeur, basé aux États-Unis (San Francisco), qui héberge les fichiers du site et traite les données de connexion des visiteurs (adresses IP, journaux de requêtes) dans le cadre de l'hébergement ;",
