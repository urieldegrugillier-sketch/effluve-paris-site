  ...
  const TRANSLATIONS = {
    en: {
      ...
      accountGate: {
        ...
        passwordHint: 'Minimum 8 characters, with at least one letter, one number, and one special character (! @ # $ % ^ & * ( ) - _ + =).',
        passwordReqLength: '8+ characters',
        passwordReqLetter: 'One letter',
        passwordReqNumber: 'One number',
        passwordReqSpecial: 'One special character (! @ # $ % ^ & * ( ) - _ + =)',
        logInBtn: 'Log In',
        ...
        errorPasswordWeak: 'Password must be at least 8 characters and include a letter, a number, and a special character (! @ # $ % ^ & * ( ) - _ + =).',
    ...
    fr: {
      ...
      accountGate: {
        ...
        passwordHint: 'Minimum 8 caractères, avec au moins une lettre, un chiffre et un caractère spécial (! @ # $ % ^ & * ( ) - _ + =).',
        passwordReqLength: '8 caractères ou plus',
        passwordReqLetter: 'Une lettre',
        passwordReqNumber: 'Un chiffre',
        passwordReqSpecial: 'Un caractère spécial (! @ # $ % ^ & * ( ) - _ + =)',
        ...
        errorPasswordWeak: 'Le mot de passe doit contenir au moins 8 caractères, dont une lettre, un chiffre et un caractère spécial (! @ # $ % ^ & * ( ) - _ + =).',
